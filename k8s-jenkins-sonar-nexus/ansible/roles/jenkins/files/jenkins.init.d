...
# Place it /etc/rc.d/init.d/jenkins
...
JENKINS_PID_FILE="$JENKINS_HOME/conf/jenkins.pid"
JENKINS_LOCKFILE="$JENKINS_HOME/conf/jenkins.lock"
...
PARAMS="--logfile=${JENKINS_HOME}/log/jenkins.log --webroot=${JENKINS_HOME}/war --daemon"
...
if [ "$JENKINS_ENABLE_ACCESS_LOG" = "yes" ]; then
    PARAMS="$PARAMS --accessLoggerClassName=winstone.accesslog.SimpleAccessLogger --simpleAccessLogger.format=combined --simpleAccessLogger.file=${JENKINS_HOME}/log/access_log"
fi
